<?php 
    ...
    class GlobalFunctions {
        ...
        public static function SitBackBtn() {
            ?> <a id="back-btn" href="<?php echo $_SERVER['HTTP_REFERER']?>"  class="btn-shape">Back</a> <?php
        }

        public static function AlertMassage($mass, $typeAlert= 'danger') {
            ?> <div class="alert <?php echo $typeAlert?>"><span><?php echo $mass?></span> <i id="X" class="fa-sharp fa-solid fa-xmark  <?php echo $typeAlert?>""></i></div> <?php
        }
